...
$password = getenv('PHPLITEADMIN_PASSWORD');

//directory relative to this file to search for databases (if false, manually list databases in the $databases variable)
$directory = '/db';
//$directory = getenv('PHPLITEADMIN_DIRECTORY');
...
$rowsNum = getenv('PHPLITEADMIN_ROWSNUM');

// reduce string characters by a number bigger than 10
$charsNum = getenv('PHPLITEADMIN_CHARSNUM');

// maximum number of SQL queries to save in the history
$maxSavedQueries = getenv('PHPLITEADMIN_MAXSAVEDQUERIES');
...
$cookie_name = getenv('PHPLITEADMIN_COOKIE_NAME');
